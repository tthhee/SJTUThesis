...
\begin{algorithm}
	\begin{algorithmic}
				...
				\Else
					\If {$Neighbor[i].Gra = NextRepairingRobot.Gra \ \&\& \ Neighbor[i].id < NextRepairingRobot.id$}
						\State $NextRepairingRobot \gets Neighbor[i]$
					\EndIf
				\EndIf
				\State $i \gets i+1$
