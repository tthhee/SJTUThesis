...
\begin{figure*}[!htbp]
	\begin{multicols}{2}
		...
		\end{center}
	\end{multicols}
	\bicaption[fig:直接自修复-无人机]{利用无人机进行集中式控制拓扑网络的直接自修复算法}{利用无人机机进行集中式控制拓扑网络的直接自修复算法\supercite{corke2004autonomous}}{Fig}{Autonomous deployment and repair of a sendor network using an unmanned aerial vehicle\supercite{corke2004autonomous}}
\end{figure*}
...
\begin{figure*}[!htbp]
	\begin{multicols}{2}
		...
		\end{center}
	\end{multicols}
	\bicaption[fig:直接自修复-同步性]{多机器人编队网络运动同步性直接自修复}{多机器人编队网络运动同步性直接自修复\supercite{Zhang2006Motion}}{Fig}{Directly self-healing for multi-robot formation motion synchronization\supercite{Zhang2006Motion}}	
\end{figure*}
...
\begin{figure*}[!htbp]
	\centering
	\begin{tabular}{cccc}
			\subfigure[]{\includegraphics[width=3cm,height=4cm]{figure1-4.a.png}} &
			\subfigure[]{\includegraphics[width=3cm,height=4cm]{figure1-4.b.png}} &
			\subfigure[]{\includegraphics[width=3cm,height=4cm]{figure1-4.c.png}} &
			\subfigure[]{\includegraphics[width=3cm,height=4cm]{figure1-4.d.png}} \\
			\subfigure[]{\includegraphics[width=3cm,height=4cm]{figure1-4.e.png}} &
			\subfigure[]{\includegraphics[width=3cm,height=4cm]{figure1-4.f.png}} & 
			\subfigure[]{\includegraphics[width=3cm,height=4cm]{figure1-4.g.png}} &
			\subfigure[]{\includegraphics[width=3cm,height=4cm]{figure1-4.h.png}} \\
	\end{tabular}
	\bicaption[fig:密度自修复-区域覆盖]{多移动机器人区域覆盖网络连接自修复算法}{多移动机器人区域覆盖网络连接自修复算法\supercite{derbakova2011decentralized}}{Fig}{Coverage and repair algorithm for multi-robot systems\supercite{derbakova2011decentralized}}
\end{figure*}
\subsection{递归自修复算法}
...
\begin{figure*}[!htbp]
	...
	\end{tabular}
	\bicaption[fig:递归自修复-DARA-1C]{使用DARA-1C算法实现传感器网络连接自修复}{使用DARA-1C算法实现传感器网络连接自修复\supercite{abbasi2009movement}}{Fig}{Using DARA-1C to repair the connectivity of WSANs\supercite{abbasi2009movement}}
\end{figure*}
...
\begin{figure}[!htbp]
	...
	\bicaption[fig:递归自修复-DARA-2C]{使用DARA-2C算法实现传感器网络2阶连通性自修复}{使用DARA-2C算法实现传感器网络2阶连通性自修复\supercite{abbasi2009movement}}{Fig}{Using DARA-2C to repair 2-connectivity of WSANs\supercite{abbasi2009movement}}
\end{figure}
...
\begin{figure}
	...
	\bicaption[fig:递归自修复-RIM]{RIM算法自修复过程}{RIM算法自修复过程\supercite{younis2010localized}}{Fig}{The self-healing process of RIM algorithm\supercite{younis2010localized}}
\end{figure}
